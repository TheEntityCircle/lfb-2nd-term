# Лабораторная 5
Прежде, чем двинуться дальше, к большим и интересным штукам, нам нужно покрыть еще одну важную и большую тему.
Библиотеки. 
...
```g++ -fPIC -shared sum.cpp mul.cpp -o libarithm.so```
...
```g++ -o main main.cpp libarithm.so```

```g++ -o main main.cpp -L. -larithm```
