...
Возьмите проект, который собирается в течение какого-то ощутимого времени (например, все тот yet_another_educational_cowsay) и воспользоваться утилитой ```time```. 
